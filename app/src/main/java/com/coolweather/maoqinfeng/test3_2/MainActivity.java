package com.coolweather.maoqinfeng.test3_2;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ProvinceList.setOnItemClickListener(new OnItemClickListener(){      //配置ArrayList点击按钮
            ...
            public void  onItemClick(AdapterView<?> parent, View view , int position , long id){
                ...
                Intent intent = new Intent(MainActivity.this, com.coolweather.maoqinfeng.test3_2.SecondActivity.class);
        ...
        switch (v.getId()){
            case R.id.ok:
                ...
                if(researchcitycode.length()>9){
                    ...
                    Intent intent = new Intent(MainActivity.this, com.coolweather.maoqinfeng.test3_2.Weather.class);
            ...
            case R.id.myconcern:
                ...
                */
                ...
                Intent intent = new Intent(MainActivity.this, com.coolweather.maoqinfeng.test3_2.MyConcernList.class);
                startActivity(intent);
                break;
        }
    }
